...
model_path = os.path.join(output_data_dir, "bpe_joint_2layer_gelu.pth.tar")
# [3] END
...
# [23] START
print(get_scores(test_src, test_tgts, model, device, sami_model, swedish_model, "greedy"))
# [23] END

# [24] START
print(translate_sentence(model, sami_sent[test_indices[5]], device, sami_model, swedish_model))
# [24] END

# [25] START
print(sami_sent[test_indices[5]])
# [25] END

# [26] START
print(swedish_sent[test_indices[5]])
# [26] END

# [27] START
print(translate_enc_sentences(model, train_src[:5], device, swedish_model))
# [27] END

# [28] START
print([swedish_sent[i] for i in train_indices[:5]])
# [28] END
